...
function setSignalValue(key, value, options = {}, fallback = 0) {
...
export function updateCollectValue(value, options = {}) {
...
export function updateChaseRangeValue(value, options = {}) {
...
export function updateChaseSpeedCyclesValue(value, options = {}) {
...
export function updateBattleSpeedValue(value, options = {}) {
